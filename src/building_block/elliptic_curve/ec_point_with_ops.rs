...
//   where T: EllipticCurveField + EllipticCurvePointAdd<EcPoint, FieldElem> + ElllipticCurvePointInv<EcPoint, FieldElem> {
//   type Target = EcPoint;
...
// impl<T> Eq for EcPointWithOps<T>
//   where T: EllipticCurveField + EllipticCurvePointAdd<EcPoint, FieldElem> + ElllipticCurvePointInv<EcPoint, FieldElem> {}

// macro_rules! impl_ec_point1_times_field_elem {
//   ($rhs: ty, $target: ty) => {
//     impl<T> ops::Mul<$rhs> for $target
//       where T: EllipticCurveField + EllipticCurvePointAdd<EcPoint, FieldElem> + ElllipticCurvePointInv<EcPoint, FieldElem> + Clone {
